...
static void mode_size(void *data, struct kde_output_device_mode_v2 *proxy,
...
static void mode_refresh(void *data, struct kde_output_device_mode_v2 *proxy,
                         int32_t refresh) {
  (void) proxy;
...
static void mode_flags(void *data, struct kde_output_device_mode_v2 *proxy,
                       uint32_t flags) {
  (void) proxy;
...
static struct mode *device_find_proxy(struct device *d,
                                      struct kde_output_device_mode_v2 *proxy) {
...
static void device_geometry(void *data, struct kde_output_device_v2 *proxy,
                            int32_t x, int32_t y, int32_t physical_width,
                            int32_t physical_height, int32_t subpixel,
                            const char *make, const char *model, int32_t transform) {
  (void) proxy; (void) x; (void) y; (void) physical_width; (void) physical_height;
...
static void device_current_mode(void *data, struct kde_output_device_v2 *proxy,
...
static void device_mode(void *data, struct kde_output_device_v2 *proxy,
                        struct kde_output_device_mode_v2 *mode) {
  (void) proxy;
  struct device *d = data;
...
static void device_scale(void *data, struct kde_output_device_v2 *proxy,
                         wl_fixed_t factor) {
  (void) data; (void) proxy; (void) factor;
}

static void device_edid(void *data, struct kde_output_device_v2 *proxy,
                        const char *raw) {
  (void) data; (void) proxy; (void) raw;
}

static void device_enabled(void *data, struct kde_output_device_v2 *proxy,
                           int32_t enabled) {
  (void) proxy;
  ((struct device *) data)->enabled = enabled != 0;
}

static void device_uuid(void *data, struct kde_output_device_v2 *proxy,
                        const char *uuid) {
  (void) data; (void) proxy; (void) uuid;
}

static void device_serial_number(void *data, struct kde_output_device_v2 *proxy,
                                 const char *serial) {
  (void) data; (void) proxy; (void) serial;
}

static void device_eisa_id(void *data, struct kde_output_device_v2 *proxy,
                           const char *eisa) {
  (void) data; (void) proxy; (void) eisa;
}

static void device_capabilities(void *data, struct kde_output_device_v2 *proxy,
                                uint32_t flags) {
  (void) proxy;
  ((struct device *) data)->capabilities = flags;
}

static void device_overscan(void *data, struct kde_output_device_v2 *proxy,
                            uint32_t overscan) {
  (void) data; (void) proxy; (void) overscan;
}

static void device_vrr_policy(void *data, struct kde_output_device_v2 *proxy,
                              uint32_t policy) {
  (void) data; (void) proxy; (void) policy;
}

static void device_rgb_range(void *data, struct kde_output_device_v2 *proxy,
                             uint32_t range) {
  (void) data; (void) proxy; (void) range;
}

static void device_name(void *data, struct kde_output_device_v2 *proxy,
                        const char *name) {
  (void) proxy;
  struct device *d = data;
...
static void device_hdr(void *data, struct kde_output_device_v2 *proxy,
                       uint32_t hdr_enabled) {
  (void) proxy;
  ((struct device *) data)->hdr = hdr_enabled ? 1 : 0;
}

static void device_sdr_brightness(void *data, struct kde_output_device_v2 *proxy,
                                  uint32_t sdr_brightness) {
  (void) data; (void) proxy; (void) sdr_brightness;
}

static void device_wcg(void *data, struct kde_output_device_v2 *proxy,
                       uint32_t wcg_enabled) {
  (void) proxy;
  ((struct device *) data)->wcg = wcg_enabled ? 1 : 0;
}

static void device_auto_rotate_policy(void *data, struct kde_output_device_v2 *proxy,
                                      uint32_t policy) {
  (void) data; (void) proxy; (void) policy;
}

static void device_icc_profile_path(void *data, struct kde_output_device_v2 *proxy,
                                    const char *path) {
  (void) data; (void) proxy; (void) path;
}

static void device_brightness_metadata(void *data, struct kde_output_device_v2 *proxy,
                                       uint32_t peak, uint32_t avg, uint32_t min) {
  (void) data; (void) proxy; (void) peak; (void) avg; (void) min;
}

static void device_brightness_overrides(void *data, struct kde_output_device_v2 *proxy,
                                        int32_t peak, int32_t avg, int32_t min) {
  (void) data; (void) proxy; (void) peak; (void) avg; (void) min;
}

static void device_sdr_gamut_wideness(void *data, struct kde_output_device_v2 *proxy,
                                      uint32_t wideness) {
  (void) data; (void) proxy; (void) wideness;
}

static void device_color_profile_source(void *data, struct kde_output_device_v2 *proxy,
                                        uint32_t source) {
  (void) data; (void) proxy; (void) source;
}

static void device_brightness(void *data, struct kde_output_device_v2 *proxy,
                              uint32_t brightness) {
  (void) data; (void) proxy; (void) brightness;
}

static void device_color_power_tradeoff(void *data, struct kde_output_device_v2 *proxy,
                                        uint32_t preference) {
  (void) data; (void) proxy; (void) preference;
}

static void device_dimming(void *data, struct kde_output_device_v2 *proxy,
                           uint32_t multiplier) {
  (void) data; (void) proxy; (void) multiplier;
}

static void device_replication_source(void *data, struct kde_output_device_v2 *proxy,
                                      const char *source) {
  (void) data; (void) proxy; (void) source;
}

static void device_ddc_ci_allowed(void *data, struct kde_output_device_v2 *proxy,
                                  uint32_t allowed) {
  (void) data; (void) proxy; (void) allowed;
}

static void device_max_bpc(void *data, struct kde_output_device_v2 *proxy,
                           uint32_t max_bpc) {
  (void) data; (void) proxy; (void) max_bpc;
}

static void device_max_bpc_range(void *data, struct kde_output_device_v2 *proxy,
                                 uint32_t min_value, uint32_t max_value) {
  (void) data; (void) proxy; (void) min_value; (void) max_value;
}

static void device_auto_max_bpc_limit(void *data, struct kde_output_device_v2 *proxy,
                                      uint32_t limit) {
  (void) data; (void) proxy; (void) limit;
}

static void device_edr_policy(void *data, struct kde_output_device_v2 *proxy,
                              uint32_t policy) {
  (void) data; (void) proxy; (void) policy;
}

static void device_sharpness(void *data, struct kde_output_device_v2 *proxy,
                             uint32_t sharpness) {
  (void) data; (void) proxy; (void) sharpness;
}

static void device_priority(void *data, struct kde_output_device_v2 *proxy,
                            uint32_t priority) {
  (void) data; (void) proxy; (void) priority;
}

static void device_auto_brightness(void *data, struct kde_output_device_v2 *proxy,
                                   uint32_t enabled) {
  (void) data; (void) proxy; (void) enabled;
}
...
static void device_hdr_icc_profile_path(void *data, struct kde_output_device_v2 *proxy,
                                        const char *path) {
  (void) data; (void) proxy; (void) path;
}

static void device_hdr_color_profile_source(void *data, struct kde_output_device_v2 *proxy,
                                            uint32_t source) {
  (void) data; (void) proxy; (void) source;
}

static void device_abm_level(void *data, struct kde_output_device_v2 *proxy,
                             uint32_t level) {
  (void) data; (void) proxy; (void) level;
}
...
static void registry_global(void *data, struct wl_registry *registry, uint32_t name,
  ...
  if (strcmp(interface, kde_output_management_v2_interface.name) == 0) {
    ...
    g.device_registry = wl_registry_bind(registry, name,
                                         &kde_output_device_registry_v2_interface, v);
    kde_output_device_registry_v2_add_listener(g.device_registry,
                                               &device_registry_listener, NULL);
  }
}
...
static void config_failure_reason(void *data, struct kde_output_configuration_v2 *config,
                                  const char *reason) {
  (void) data; (void) config;
  snprintf(g.failure_reason, sizeof(g.failure_reason), "%s",
           reason ? reason : "");
}
 ...
 */
static struct mode *find_mode(struct device *d, int width, int height,
                              int refresh_mhz, int tolerance) {
...
static const char *onoff(int v) {
  return v > 0 ? "enable" : v == 0 ? "disable" : "unknown";
}
 ...
 */
static int parse_mode_spec(const char *spec, int *width, int *height,
                           int *refresh_mhz, int *tolerance) {
  int w, h, r;
  char extra;
...
static int cmd_list(void) {
  for (size_t i = 0; i < g.ndevices; i++) {
    ...
    for (size_t j = 0; j < d->nmodes; j++) {
      ...
      printf("  mode %d: %dx%d@%d%s%s%s\n", id++, m->width, m->height, m->refresh,
             m == d->current ? " current" : "",
             m->preferred ? " preferred" : "",
             (m->flags & KDE_OUTPUT_DEVICE_MODE_V2_FLAGS_CUSTOM) ? " custom" : "");
    }
...
static int cmd_current(const char *name) {
  ...
  printf("%d %dx%d@%d hdr=%s wcg=%s\n", id, d->current->width, d->current->height,
         d->current->refresh, onoff(d->hdr), onoff(d->wcg));
  return 0;
}
 ...
 */
static void mode_list_add(struct kde_mode_list_v2 *list, int width, int height,
                          int refresh_mhz, bool reduced_blanking) {
...
static int cmd_apply(const char *name, const char *spec, int hdr, int wcg, bool rb) {
  ...
  if (!target) {
    ...
    if (!(d->capabilities & KDE_OUTPUT_DEVICE_V2_CAPABILITY_CUSTOM_MODES)) {
      fprintf(stderr, LOG_PREFIX "%dx%d@%d not advertised and output '%s' "
    ...
    for (size_t i = 0; i < d->nmodes; i++) {
      ...
      if (m->proxy && (m->flags & KDE_OUTPUT_DEVICE_MODE_V2_FLAGS_CUSTOM) &&
        ...
        mode_list_add(list, m->width, m->height, m->refresh,
                      (m->flags & KDE_OUTPUT_DEVICE_MODE_V2_FLAGS_REDUCED_BLANKING) != 0);
      }
    }
  ...
  fprintf(stderr, LOG_PREFIX "applied %dx%d@%d on %s (hdr=%s wcg=%s)\n",
          width, height, refresh_mhz, name,
          hdr >= 0 ? onoff(hdr) : "unchanged",
          wcg >= 0 ? onoff(wcg) : "unchanged");
  return 0;
}
...
static int setup(void) {
  ...
  if (!g.management || !g.device_registry) {
    fprintf(stderr, LOG_PREFIX "compositor lacks kde_output_management_v2 or "
