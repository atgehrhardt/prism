...
##### Web UI
Prism uses [Vue I18n](https://vue-i18n.intlify.dev) for localizing the UI.
...
#### Unit Testing
Prism uses [Google Test](https://github.com/google/googletest) for unit testing. Google Test is included in the
