...
if((DEFINED ENV{BRANCH}) AND (DEFINED ENV{BUILD_VERSION}))  # cmake-lint: disable=W0106
    ...
    # Generate Prism Version based of the git tag
...
list(APPEND PRISM_DEFINITIONS PROJECT_FQDN="${PROJECT_FQDN}")
list(APPEND PRISM_DEFINITIONS PROJECT_NAME="${PROJECT_NAME}")
list(APPEND PRISM_DEFINITIONS PROJECT_VERSION="${PROJECT_VERSION}")
list(APPEND PRISM_DEFINITIONS PROJECT_VERSION_MAJOR="${PROJECT_VERSION_MAJOR}")
list(APPEND PRISM_DEFINITIONS PROJECT_VERSION_MINOR="${PROJECT_VERSION_MINOR}")
list(APPEND PRISM_DEFINITIONS PROJECT_VERSION_PATCH="${PROJECT_VERSION_PATCH}")
list(APPEND PRISM_DEFINITIONS PROJECT_VERSION_COMMIT="${GITHUB_COMMIT}")
