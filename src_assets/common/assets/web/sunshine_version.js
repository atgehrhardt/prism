class PrismVersion {
  ...
  isGreater(otherVersion) {
    ...
    if (otherVersion instanceof PrismVersion) {
      ...
      throw new Error('Invalid argument: otherVersion must be a PrismVersion object or a version string');
    }
