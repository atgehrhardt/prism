...
<template>
  <div id="files" class="config-page">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="credentials_file" placeholder="prism_state.json" v-model="config.credentials_file" />
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="log_path" placeholder="prism.log" v-model="config.log_path" />
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="file_state" placeholder="prism_state.json"
